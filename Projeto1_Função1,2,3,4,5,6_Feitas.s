...
main:
	...
	menu:
		...
		empilharEnderecosMenu5:
		bne $s0, $s1, empilharMenu5
		j terminouDeEmpilharMenu5
		empilharMenu5:
		...
		j empilharEnderecosMenu5
		terminouDeEmpilharMenu5:
		...
		ordenandoFor1Menu5:
		bne $s5, $sp, ordenandoPilhaMenu5
		j acabouOrdenarMenu5
		ordenandoPilhaMenu5:
		bne $s4, $s6, ordenarMenu5
		addi $s4, $a3, -8
		addi $s6, $s6, 8
		addi $s5, $s5, -8
		j ordenandoFor1Menu5
		ordenarMenu5:
		lw $a0, 4($s4)
		lw $a1, -4($s4)
		...
		bne $s0, $s1, empilharMenu6
		j terminouDeEmpilharMenu6
		empilharMenu6:
		...
		ordenandoFor1Menu6:
		bne $s5, $sp, ordenandoPilhaMenu6
		j acabouOrdenarMenu6
		ordenandoPilhaMenu6:
		bne $s4, $s6, ordenarMenu6
		addi $s4, $a3, -8
		addi $s6, $s6, 8
		addi $s5, $s5, -8
		j ordenandoFor1Menu6
		ordenarMenu6:
		l.s $f1, 0($s4)
		l.s $f2, -8($s4)
